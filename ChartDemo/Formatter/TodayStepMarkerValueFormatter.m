...
@interface TodayStepMarkerValueFormatter()
@property (nonatomic, strong) NSMutableArray<BarChartDataEntry *> *yValues;
@end

@implementation TodayStepMarkerValueFormatter
...
/**
 * 每分钟一个步数数据，绘制柱状图每20分钟记一个柱体，一天有(60/20 * 24 + 1)个柱体,多出了的一个刻度是为了显示出00:00这个时间点
